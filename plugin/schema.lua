...
local map_with_referenceable_value = {
  type = "map",
  keys = { type = "string" },
  values = {
    type = "string",
...
-- local colon_strings_array_record_plus_uri = cycle_aware_deep_copy(bhq)
    ...
    { config = {
        ...
        fields = {
          ...
          { headers = {
            type = "record",
            fields = {
              { add = map_with_referenceable_value },
              { append = map_with_referenceable_value },
            }
          }}
        }
      },
